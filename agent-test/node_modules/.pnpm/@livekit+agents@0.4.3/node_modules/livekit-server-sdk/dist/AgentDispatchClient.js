...
import { AgentDispatch, CreateAgentDispatchRequest, DeleteAgentDispatchRequest, ListAgentDispatchRequest, ListAgentDispatchResponse, } from '@livekit/protocol';
...
export class AgentDispatchClient extends ServiceBase {
    ...
    async createDispatch(roomName, agentName, options) {
        ...
        const data = await this.rpc.request(svc, 'CreateDispatch', req, await this.authHeader({ roomAdmin: true, room: roomName }));
    ...
    async deleteDispatch(dispatchId, roomName) {
        ...
        await this.rpc.request(svc, 'DeleteDispatch', req, await this.authHeader({ roomAdmin: true, room: roomName }));
    }
    /**
    ...
    async getDispatch(dispatchId, roomName) {
        ...
        const data = await this.rpc.request(svc, 'ListDispatch', req, await this.authHeader({ roomAdmin: true, room: roomName }));
